      ...
      <section className="excel-layout">
        ...
        <section className="admin-panel excel-upload-panel">
          ...
          <p>
            ...
            ячейки не принимаются. Для мероприятия с потоками добавьте колонку
            «Поток» с точным названием потока для каждого участника.
          </p>
            ...
            <section className="admin-panel excel-confirm-panel">
              ...
              {preview.summary.exceedsCapacity && (
                <label className="excel-override">
                  ...
                  />
                  <span>
                    Подтверждаю превышение лимита мероприятия или выбранного
                    потока
                  </span>
                </label>
              )}
