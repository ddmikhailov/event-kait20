...
Контур расширяет Event KAIT20 до единой основы для будущей интеграции с
Active/MosActive. Он не заменяет регистрацию и Scanner:
...
StudentMembership хранит историческую принадлежность к группе и отделению.
