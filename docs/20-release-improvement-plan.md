...
Приоритет: **высокий перед первым крупным Event**.
...
После Этапа 1 следующий кодовый блок — security regression и release-readiness
отчёт. Затем браузерный E2E, нагрузочный сценарий и monitoring helpers. Staging и
