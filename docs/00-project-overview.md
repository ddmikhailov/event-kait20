...
Все интерфейсы используют единый backend и MySQL 8.1.0.
...
На реальном мероприятии сотрудник должен быстро сканировать поток участников без
ручного поиска по бумажным спискам, а SUPER_ADMIN/ORGANIZER должен сразу получать
корректный список пришедших и статистику.
