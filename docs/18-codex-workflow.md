...
A task must not silently replace MySQL 8.1.0, the approved deployment direction, PWA scanner, modular monolith, React/Vite or Python 3.12/FastAPI. Architecture changes require an updated ADR and explicit owner approval.
