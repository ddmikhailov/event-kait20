...
> Архивный снимок исходной документации. Решение о PostgreSQL в этом файле
> отменено ADR-008; актуальная БД — MySQL 8.1.0. Для реализации использовать
> отдельные канонические файлы в `docs/`, а не этот снимок.
