  ...
  if (fresh) {
    ...
    writeFileSync(
      ...
      [
        ...
        "GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, ALTER, INDEX, REFERENCES, CREATE TEMPORARY TABLES ON event_registration_demo.* TO 'event_app'@'localhost';",
        "GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, ALTER, INDEX, REFERENCES, CREATE TEMPORARY TABLES ON event_registration_demo.* TO 'event_app'@'127.0.0.1';",
        'FLUSH PRIVILEGES;',
        '',
      ].join('\n'),
      { encoding: 'utf8', mode: 0o600 },
