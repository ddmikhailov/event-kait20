...
МосАктив развивается как модуль этой же платформы: общие студенты,
подтверждённые участия и начисления за мероприятия формируют публичный рейтинг
и карточки без входа для посетителей. Достижения и полный профиль доступны
только администраторам. Состояние модуля и недостающие шаги
для загрузки реального контингента описаны в
[`docs/MOSACTIVE-PUBLIC-READINESS.md`](docs/MOSACTIVE-PUBLIC-READINESS.md).
