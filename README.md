...
подтверждённые участия, достижения и журнал баллов формируют публичный рейтинг
и цифровое досье без входа для посетителей. Состояние модуля и недостающие шаги
